...
public class GameScreenHUD implements Disposable {
    ...
    private final ArrayList<CustomButton> buttons;

    /** @param spriteBatch The sprite batch for the game. */
    public GameScreenHUD(Core game, SpriteBatch spriteBatch) {
        this.scoreValue = 0;
        Viewport viewport = new FitViewport(Core.V_WIDTH, Core.V_HEIGHT, new OrthographicCamera());
        ...
        buttons.add(new CustomButton("Back", new Vector2(10, 10), new Vector2(100, 50)));
